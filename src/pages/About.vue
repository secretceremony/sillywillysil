        ...
        <v-row align="center" justify="center">
          <v-col cols="12" md="6">
            <h1 class="text-h3 text-md-h2 font-weight-bold mb-4">
              Nice to meet you! I'm Sil.
            </h1>
            <p class="text-subtitle-1 mb-6">
              I'm an Information Systems student who is also a digital artist and beginner web developer. I am passionate about UI/UX design and character design!
            </p>
          </v-col>
